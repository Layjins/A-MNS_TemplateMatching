...
*/
    ...
    */
    ...
    int ImgNum=10;//每类的图像数量（即每个文件夹里面的图片数量）
    ...
    for(int i=1;i<=ClassNum;i++)
    {
        ...
        sprintf(Path_template,"F:/MyAlgorithmProject/20170601_TemplateMatching_FeatureBase_RPT_Zernike/QtCode/QtCode_MNS_MostNeighborsSimilarity(20180223)/TextImage/1Occlusion/%d/00template.bmp",i);
        cv::Mat TemplateImage=cv::imread(Path_template);
        //获取原图路径
        char Path_origin[200];
        sprintf(Path_origin,"F:/MyAlgorithmProject/20170601_TemplateMatching_FeatureBase_RPT_Zernike/QtCode/QtCode_MNS_MostNeighborsSimilarity(20180223)/TextImage/1Occlusion/%d/0.jpg",i);
        ...
        MNShsv_SSDtMatching2_Fast(originImage,TemplateImage,TrueMatchUpLPoint,TrueMatchTime);//特征：环投影均值、灰度均值和方差、HSV分量均值
        ...
        for(int j=1;j<=10;j=j+1)
        {
            //获取待匹配图路径
            char Path_img[200];
            sprintf(Path_img,"F:/MyAlgorithmProject/20170601_TemplateMatching_FeatureBase_RPT_Zernike/QtCode/QtCode_MNS_MostNeighborsSimilarity(20180223)/TextImage/1Occlusion/%d/%d.jpg",i,j);
            ...
            //匹配率
            float distance1=get_distance(MatchUpLPoint[0],TrueMatchUpLPoint[0]);
    ...
    oFile << "MNS" << "," << ClassNum*ImgNum << "," << MNS_SuccessRate << "," << MNS_aver_SumTime<< "," << MNS_aver_SumTime-MNS_averSecond_SumTime << "," << MNS_averSecond_SumTime << endl;
    oFile.close();
