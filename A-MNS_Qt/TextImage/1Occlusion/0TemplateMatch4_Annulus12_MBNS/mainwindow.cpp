...
void MainWindow::on_pushButtonMatch_clicked()
{
    ...
    //****************************
    //****************************
    int QI=10;//Quantity of Images
    for(int i=1;i<QI+1;i++)
    {
        char strpath[200];
        sprintf(strpath,"F:/MyAlgorithmProject/20170601_TemplateMatching_FeatureBase_RPT_Zernike/QtCode/QtCode_SelfBestBuddiesSimilarity(20180223)/TextImage/1Occlusion/wine_label10/%d.jpg",i);
